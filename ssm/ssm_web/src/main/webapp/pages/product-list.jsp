                        ...
                        <div class="pull-left">
                            <div class="form-group form-inline">
                                <div class="btn-group">
                                    ...
                                    <button type="button" class="btn btn-default" title="状态更改"><i class="glyphicon glyphicon-resize-horizontal"></i> 状态更改</button>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <button type="button" class="btn bg-olive btn-xs"
                                            onclick="location.href='${pageContext.request.contextPath}/product/delete.do?id=${product.id}'">删除</button>
                                </td>
                            </tr>
                        </c:forEach>
                            </tbody>
                ...
                <div class="box-footer">
                    ...
                    <div class="box-tools pull-right">
                        <ul class="pagination">
                            ...
                            <li><a href=${pageContext.request.contextPath}/product/findAll.do?${pageInfo.pageNum+1}&${pageInfo.pageSize}">下一页</a></li>
                            <li>
                                <a href="${pageContext.request.contextPath}/product/findAll.do?${pageInfo.pages}&size=${pageInfo.pageSize}" aria-label="Next">尾页</a>
                            </li>
                        </ul>
                    </div>
